...
export class KernelResultsReceiver {
  ...
  addCellMetadata(metadata) {
    ...
    if (this.supportsCellMetadata(buffer)) {
      ...
      metadata = _.omitBy(
        {
          ...parseCellMetadata(cellText).metadata,
          ...metadata,
        },
      ...
      if (!_.isEmpty(metadata)) {
        ...
        buffer.setTextInRange(delimLineRange, delimLineText);

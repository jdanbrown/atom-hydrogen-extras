...
export class IpynbSync {
  ...
  reloadOutputsFromIpynb() {
    ...
    try {
      ...
      //  - TODO TODO Fix short-circuit to avoid reloading on save (so we don't lose track of currently running cell)
      //    - TODO Need _old_ and new ipynb_hash, from getPyFromIpynbSource
  ...
  getIpynbFromPyEditor() {
    ...
    try {
      ...
      const ipynbJson = this.jsonStringifyLikeJupyter(ipynb);

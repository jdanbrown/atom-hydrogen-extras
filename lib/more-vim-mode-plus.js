...
export const {nextCodeChunkDelimInDirection, codeChunkContainingPoint} = require('./cells');
...
export class MoveToNextCell extends MoveToNextParagraph {
  getPoint(from) {
    return nextCodeChunkDelimInDirection('cell', this.editor, this.direction, from);
  }
}

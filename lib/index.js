...
const module = {
  ...
  _config: {
    trackOutput: false, // TODO I've wanted this as a setting [TODO Warn/fail/prevent if Hydrogen.autoScroll:true]
    unsetPYTHONSTARTUP: true, // TODO I've wanted this as a setting (e.g. work vs. personal)
    highlightCells: true,
    showCellTimesOver: 1, // Seconds
    skipHtml: false, // For dev
    shutdownKernelOnDetach: false,
  },
